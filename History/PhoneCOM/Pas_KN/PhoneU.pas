...
{$EndIf EnableLogCapability}
    ...
    function AddEvent(const AEvent : TPhoneEvent; const AText : String; const AUser : LongInt) : Boolean;
    function CreatePortConnection : Boolean;
    function DeleteEventHandle(const AEvent : TPhoneEvent; const AUser : LongInt) : LongWord;
    function DeleteEventHandleText(const AEvent : TPhoneEvent; const AText : String; const AUser : LongInt) : LongWord;
    function DeleteEventText(const AText : String; const AUser : LongInt) : LongWord;
...
{$EndIf EnableSimCodeForm}
    ...
    function IsKnownEventHandleText(const AEvent : TPhoneEvent; const AText : String; const AUser : LongInt) : Boolean;
    function IsKnownEventText(const AText : String; const AUser : LongInt) : Boolean;
    ...
    procedure InterpretMessage(const ANumber : String; AText : String);
  published
  end;
  ...
  protected
    ...
    FEventUser  : LongInt;
  public
    constructor Create(const AEvent : TPhoneEvent; const AText : String; const AUser : LongInt);
  ...
  public
    ...
    function AddEvent(const AEvent : TPhoneEvent; const AText : String; const AUser : LongInt) : LongInt;
    function DeleteEventHandle(const AEvent : TPhoneEvent; const AUser : LongInt) : LongWord;
    function DeleteEventHandleText(const AEvent : TPhoneEvent; const AText : String; const ACaseSensitive : Boolean; const AUser : LongInt) : LongWord;
    function DeleteEventIndex(const AIndex : LongInt) : Boolean;
    function DeleteEventText(const AText : String; const ACaseSensitive : Boolean; const AUser : LongInt) : LongWord;
    function GetEventHandle(const AEvent : TPhoneEvent; const AUser : LongInt) : TPhoneEventDataArray;
    function GetEventHandleText(const AEvent : TPhoneEvent; const AText : String; const ACaseSensitive : Boolean; const AUser : LongInt) : TPhoneEventDataArray;
    function GetEventText(const AText : String; const ACaseSensitive : Boolean; const AUser : LongInt) : TPhoneEventDataArray;
    function GetEventTextAll(const AText : String; const ACaseSensitive : Boolean) : TPhoneEventDataArray;
...
{$EndIf EnableLogCapability}
      ...
      begin
        ...
        begin
          ...
          InterpretMessage(HandyNumber, CRingEventText);
        end
        else
          InterpretMessage(CNumberNotSentText, CRingEventText);
...
{$EndIf EnableLogCapability}
            InterpretMessage(HandyNumber, SMSToASCII(HandyText));
          end
          else
          begin
{$IfDef EnableLogCapability}
...
{$EndIf EnableLogCapability}
            InterpretMessage(HandyNumber, HandyText);
          end;
...
function TPhoneEngine.AddEvent(const AEvent : TPhoneEvent; const AText : String; const AUser : LongInt) : Boolean;
begin
{$IfDef EnableLogCapability}
  if (AText <> CRingEventText) then
...
{$EndIf EnableLogCapability}
  ...
  Result := (FEventList.AddEvent(AEvent, AText, AUser) >= 0);
...
function TPhoneEngine.DeleteEventHandleText(const AEvent : TPhoneEvent; const AText : String; const AUser : LongInt) : LongWord;
begin
{$IfDef EnableLogCapability}
  if (AText <> CRingEventText) then
...
{$EndIf EnableLogCapability}
  ...
  Result := FEventList.DeleteEventHandleText(AEvent, AText, FCaseSensitive, AUser);
...
function TPhoneEngine.DeleteEventText(const AText : String; const AUser : LongInt) : LongWord;
begin
{$IfDef EnableLogCapability}
  if (AText <> CRingEventText) then
...
{$EndIf EnableLogCapability}
  ...
  Result := FEventList.DeleteEventText(AText, FCaseSensitive, AUser);
...
function TPhoneEngine.IsKnownEventHandleText(const AEvent : TPhoneEvent; const AText : String; const AUser : LongInt) : Boolean;
begin
  Result := (Length(FEventList.GetEventHandleText(AEvent, AText, FCaseSensitive, AUser)) > 0);
end;

function TPhoneEngine.IsKnownEventText(const AText : String; const AUser : LongInt) : Boolean;
begin
  Result := (Length(FEventList.GetEventText(AText, FCaseSensitive, AUser)) > 0);
end;
...
procedure TPhoneEngine.InterpretMessage(const ANumber : String; AText : String);
...
begin
  EventDataArray := FEventList.GetEventTextAll(CAllEventsText, FCaseSensitive);
...
{$EndIf DLLMethods}
  ...
  EventDataArray := FEventList.GetEventTextAll(ValueArray[0], FCaseSensitive);
  if (Length(EventDataArray) > 0) then
  begin
    for Index := Low(EventDataArray) to High(EventDataArray) do
    begin
      ...
      begin
{$IfDef EnableLogCapability}
        if (ValueArray[0] <> CRingEventText) then
...
constructor TPhoneEventData.Create(const AEvent : TPhoneEvent; const AText : String; const AUser : LongInt);
begin
  inherited Create;
...
function TPhoneEventDataList.AddEvent(const AEvent : TPhoneEvent; const AText : String; const AUser : LongInt) : LongInt;
begin
  Result := Add(TPhoneEventData.Create(AEvent, AText, AUser));
end;
...
function TPhoneEventDataList.DeleteEventHandleText(const AEvent : TPhoneEvent; const AText : String; const ACaseSensitive : Boolean; const AUser : LongInt) : LongWord;
var
  Index : LongInt;
begin
  Result := 0;
  ...
  begin
    ...
    begin
      if (((TPhoneEventData(Items[Index]).User = AUser) or (FIgnoreUser)) and
          ...
          (CaseSensitive(TPhoneEventData(Items[Index]).Text, ACaseSensitive) = CaseSensitive(AText, ACaseSensitive))) then
      begin
        TPhoneEventData(Items[Index]).Free;
...
function TPhoneEventDataList.DeleteEventText(const AText : String; const ACaseSensitive : Boolean; const AUser : LongInt) : LongWord;
var
  Index : LongInt;
begin
  Result := 0;
...
function TPhoneEventDataList.GetEventHandleText(const AEvent : TPhoneEvent; const AText : String; const ACaseSensitive : Boolean; const AUser : LongInt) : TPhoneEventDataArray;
var
  Counter : LongInt;
  Index   : LongInt;
begin
...
function TPhoneEventDataList.GetEventText(const AText : String; const ACaseSensitive : Boolean; const AUser : LongInt) : TPhoneEventDataArray;
var
  Counter : LongInt;
  Index   : LongInt;
begin
...
function TPhoneEventDataList.GetEventTextAll(const AText : String; const ACaseSensitive : Boolean) : TPhoneEventDataArray;
var
  Counter : LongInt;
  Index   : LongInt;
begin
  ...
  begin
    if (Items[Index] <> nil) then
    begin
      if (CaseSensitive(TPhoneEventData(Items[Index]).Text, ACaseSensitive) = CaseSensitive(AText, ACaseSensitive)) then
      begin
        Result[Counter] := TPhoneEventData(Items[Index]);
